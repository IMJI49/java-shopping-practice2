...
public class UserServiceTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("\tUserService 비지니스 로직 테스트");
		System.out.println("=".repeat(50));
		setUp();
		// 테스트 실행
		System.out.println("1. 회원 가입 기능 테스트");
	...
	private static void testRegisterWithDuplicate() {
		...
		try {
			...
			printTestResult(testName, false, "예상치 못한 예외 : "+e.getLocalizedMessage());
		}
	}
	...
	private static void testRegisterSuccess() {
		...
		try {
			...
			printTestResult(testName, false, e.getLocalizedMessage());
		}
	}
	...
	private static void clearTestData() {
		try {
			...
			System.err.println("[경고] 데이터 초기화 실패 : " + e.getLocalizedMessage());
		}
